...
namespace Dream
{
	...
	void Run()
	{
		...
		textureBarrier.SourceQueue = GraphicsQueueType::Graphics;
		...
		textureBarrier.DestinationQueue = GraphicsQueueType::Graphics;
		...
		pCmdList->SetTextureMemoryBarrier(pTexture, textureBarrier);
