...
namespace Dream
{
	...
	private:
		...
		virtual void SetVertexBufferCore(GraphicsBuffer** ppBuffers,const unsigned char count) override;
		...
		virtual void SetViewportsCore(const ViewportDesc** ppViewports, const unsigned char count) override;
		virtual void SetScissorsCore(const ScissorDesc** ppScissors, const unsigned char count) override;
